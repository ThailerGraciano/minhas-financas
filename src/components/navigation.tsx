  ...
  return (
    <>
      ...
      >
        ...
        >
          <Image src={LogoIcon} alt="Logo" width={32} height={32} className="shrink-0 rounded-full" />
          {!isCollapsed && (
            <span className="text-xl font-bold tracking-tight whitespace-nowrap overflow-hidden">Finanças</span>
          )}
        </div>
