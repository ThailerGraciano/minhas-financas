...
export function MarketTopCategoryItemsChart({ data }: MarketTopCategoryItemsChartProps) {
  if (data.length === 0) {
    return (
      <Card className="rounded-3xl sm:rounded-[2rem] border-transparent shadow-sm flex flex-col h-full md:col-span-2 w-full overflow-hidden">
  ...
  return (
    <Card className="rounded-3xl sm:rounded-[2rem] border-transparent shadow-sm flex flex-col h-full md:col-span-2 w-full min-w-0 overflow-hidden">
